...
export default function Home() {
  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <section className="w-full bg-gradient-to-br from-blue-50 via-white to-blue-100 py-24 mb-16">
      ...
      <section className="container max-w-4xl mx-auto mb-24 px-4">
        <div className="bg-blue-50 rounded-xl shadow-md p-8">
          ...
          <ul className="space-y-6 text-lg text-gray-800 list-disc pl-8">
            <li>
      ...
      {/* Divider */}
      <div className="container mx-auto max-w-4xl mb-16 px-4">
      ...
      <section className="container mb-16">
        <div className="flex justify-between items-center mb-6">
          <h2 className="section-title text-xl font-bold text-gray-900">Recent Resources</h2>
            ...
            {resources.length === 0 ? (
              ...
              resources.map((res) => (
                <a
                  ...
                  className="min-w-[250px] max-w-xs bg-white card hover:shadow-xl shadow-md rounded-xl transition-shadow duration-300 border border-gray-100"
                >
                  <img
                    src={res.thumbnail}
                    alt={res.title}
      ...
      <section className="container mb-24">
        <div className="flex justify-between items-center mb-6">
          <h2 className="section-title text-xl font-bold text-gray-900">Upcoming Events</h2>
            ...
            {upcomingEventsOnly.length === 0 ? (
              ...
              upcomingEventsOnly.map((evt) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="min-w-[250px] max-w-xs bg-white card hover:shadow-xl shadow-md rounded-xl transition-shadow duration-300 border border-gray-100 p-4"
                >
                  <img
                    src= {evt.thumbnail} 
